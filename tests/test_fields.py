...
def test_text_field():
    ...
    test_value = "test"
    models.TestTextFieldModel.objects.create(test_field=test_value)
...
def test_email_field():
    ...
    models.TestEmailFieldModel.objects.create(test_field=test_value)
...
def test_ipadress_field():
    ...
    models.TestIPAddressFieldModel.objects.create(test_field=test_value)
...
def test_nullboolean_field():
    ...
    test_value = True
    models.TestNullBooleanFieldModel.objects.create(test_field=test_value)
...
def test_time_field():
    ...
    models.TestTimeFieldModel.objects.create(test_field=test_value)
...
def test_date_field():
    ...
    models.TestDateFieldModel.objects.create(test_field=test_value)
...
def test_datetime_field():
    ...
    models.TestDateTimeFieldModel.objects.create(test_field=test_value)
...
def test_bigint_field():
    ...
    models.TestBigIntegerFieldModel.objects.create(test_field=test_value)
...
def test_smallint_field():
    ...
    test_value = -32768
    models.TestSmallIntegerFieldModel.objects.create(test_field=test_value)
...
def test_int_field():
    ...
    models.TestIntegerFieldModel.objects.create(test_field=test_value)
...
def test_uuid_field():
    ...
    models.TestUUIDFieldModel.objects.create(test_field=test_value)
